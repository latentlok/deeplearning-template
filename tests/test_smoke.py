...
def _ddp_worker(rank: int, world: int, port: int, out: str) -> None:
    ...
    from dlt.core.trainer import Trainer
    from dlt.project.mlp import MLP, SyntheticData
...
def test_complex_weights_are_split_in_histograms_and_named_in_checkpoint_errors(
    ...
    """
    from dlt.core.base import OptimSpec, TaskModule
    from dlt.core.callbacks import GradStats
    from dlt.core.checkpoint import SafetensorsFormat
    from dlt.core.tracking import TensorBoardLogger
